//JJ-SoundEffects.cpp
//Created by Jaidin  Jackson  on 3/29/19.
//Copyright © 2019 Jaidin  Jackson . All rights reserved.
...
bool loadMedia()
{
    ...
    //Load prompt texture
    if( !gPromptTexture.loadFromFile( "21_sound_effects_and_music/RAISIN3.png" ) )
    {
    ...
    gHigh = Mix_LoadWAV( "21_sound_effects_and_music/dog_bark.wav" );
    if( gHigh == NULL )
    {
